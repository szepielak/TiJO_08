(function ()
{
    ...
    app.directive('shipSender', function ()
    {
        return {
            ...
            '<button id="checkButton" class="btn btn-info voffset" ng-click="answer = customCheck({boat: myBoat, currentConditions: conditions})">Check</button></div></div>'
        };
    });
})();
